...
function crearMain() {
    ...
    heroSection.style.cssText = 'background-image: url("./RECURSOS/principal.jpg"); background-size: cover; height: calc(100vh - 30px); display: flex; justify-content: center; align-items: center; text-align: center; color: white; margin-bottom: 0;';
